...
const EXPECTED = {
  ...
  viewQuotations: ["admin", "manager", "technician", "techlead"],
  editDocuments: ["admin", "manager"],
  viewFinance: ["admin", "manager", "technician", "techlead", "user"],
  editFinance: ["admin", "manager"],
  viewContracts: ["admin", "manager", "technician", "techlead"],
  ...
  requestExpense: ["admin", "manager", "technician", "techlead"],
