...
const EXPECTED = {
  ...
  approveJobs: ["techadmin", "manager", "director"],
  viewAllJobs: ["techadmin", "manager", "director"],
  editAnyJob: ["techadmin", "manager", "director"],
  editOperation: ["techadmin", "manager", "director", "user"],
  // ⚠️ ตัด sale ออกตามที่ผู้ใช้สั่ง — ทั้งสองหน้าเป็นเรื่องของงานช่าง ไม่ใช่ดีล/ยอดขายของเซล
  viewQuotations: ["techadmin", "manager", "director", "technician", "techlead"],
  viewDocuments: ["techadmin", "manager", "director", "techlead", "technician", "user"],
  editDocuments: ["techadmin", "manager", "director"],
  viewFinance: ["techadmin", "manager", "director", "technician", "techlead", "user"],
  editFinance: ["techadmin", "manager", "director"],
  viewContracts: ["techadmin", "manager", "director", "technician", "techlead"],
  editContracts: ["techadmin", "manager", "director"],
  manageMasterData: ["techadmin", "manager", "director"],
  createSalesPlan: ["techadmin", "manager", "director", "sale"],
  viewAllSales: ["techadmin", "manager", "director"],
  requestDispatch: ["techadmin", "manager", "director", "sale"],
  assignDispatch: ["techadmin", "manager", "director"],
  receiveDispatch: ["technician", "techlead"],
  ...
  approveOwnExpense: ["techadmin", "manager", "director"],
  viewAllExpenses: ["techadmin", "manager", "director"],
