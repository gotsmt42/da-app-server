...
const EXPECTED = {
  ...
  viewContracts: ["admin", "manager", "director", "technician", "techlead"],
  editContracts: ["admin", "manager", "director"],
  manageMasterData: ["admin", "manager", "director"],
  createSalesPlan: ["admin", "manager", "director", "sale"],
  viewAllSales: ["admin", "manager", "director"],
  requestDispatch: ["admin", "manager", "director", "sale"],
  assignDispatch: ["admin", "manager", "director"],
  ...
  reviewExpense: ["admin", "manager", "director"],
  approveExpense: ["admin", "manager", "director"],
  approveOwnReview: ["manager", "director"],
