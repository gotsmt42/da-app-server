...
const CAPABILITIES = {
  ...
  /**
   * ── ลำดับการเบิกค่าใช้จ่าย 4 ขั้น (ใช้เหมือนกันทั้งใบ Advance / ใบเคลม / ใบสำรองจ่าย) ──
   * ✅ ผู้ใช้สั่ง "จัดการเรียงลำดับการจัดการการเบิกค่าใช้จ่ายใหม่":
   *
   *   ขั้น 1  ส่งขอเบิก        ทุกสิทธิ์ที่เบิกได้ (รวมผู้จัดการ/กรรมการ)   ลายเซ็นช่อง "ผู้เบิก"
   *   ขั้น 2  ตรวจสอบ          reviewExpense    แอดมินช่าง · ผู้จัดการฯ   ลายเซ็นช่อง "ผู้ตรวจสอบ"
   *   ขั้น 3  อนุมัติ           approveExpense   ผู้จัดการแผนกช่าง         ลายเซ็นช่อง "ผู้อนุมัติ"
   *   ขั้น 4  อนุมัติเบิกจ่าย   disburseExpense  ผู้จัดการฯ · กรรมการฯ     ลายเซ็นช่อง "ผู้อนุมัติเบิกจ่าย"
   *
   ...
   *
   * ขั้น 2 — ✅ "ให้แค่แอดมิน และผู้จัดการเท่านั้น ที่ดำเนินการและอนุมัติตรวจสอบได้"
  ...
  /**
   * ขั้น 3 — อนุมัติ · ✅ "พอแอดมินอนุมัติตรวจสอบเสร็จ ให้ส่งแจ้งเตือนแค่ผู้จัดการที่อนุมัติ แล้วจัดการต่อ"
   * ⚠️ อนุมัติได้เฉพาะใบที่ "ผ่านการตรวจสอบแล้ว" เสมอ · แอดมินไม่มีสิทธิ์นี้แล้ว (แอดมิน = ผู้ตรวจสอบ)
   */
  approveExpense: [ROLES.MANAGER],

  /**
   * ขั้น 4 — อนุมัติเบิกจ่าย (บันทึกการจ่ายเงิน Advance / ปิดส่วนต่างใบเคลม / จ่ายคืนใบสำรองจ่าย)
